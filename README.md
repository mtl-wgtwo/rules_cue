...
1. search for "com_wgtwo_rules_cue" and replace with the name you'll use for your workspace
1. search for "wgtwo" and replace with GitHub org
1. search for "cue" and replace with the language/tool your rules are for
1. rename directory "cue" similarly
